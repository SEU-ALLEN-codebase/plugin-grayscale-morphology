                                ...
                                V3DPluginArgList & output, V3DPluginCallback2 & callback,  QWidget * parent)
{
    ...
    try
    {
        ...
        else if (func_name == tr("auto_thr"))
            action = QSharedPointer<BaseAction>(new AutoThrAction);
        ...
        else
        {
            ...
            qDebug() << "auto_thr: estimate a normal distribution for the background, and give a threshold based "
                        "on a provided quantile.";
            ...
            qDebug() << "v3d -x neuron_image_denoise -f auto_thr -i in.tif -o out.tif -p bg_pct 0.95 norm_qtl 0.95";
